...
sum_two_values("5", "7") #Los concatena
...
my_result = sum_two_values(1.4, 5.2) #Se ejecuta
print(my_result) #Cómo no se retorna nada dará none
...
print_name(surname="Tirado", name="Carlos")
